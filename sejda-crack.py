...
class SejdaCrack:
    ...
    def main(self):
        self.print("🔥", f"Sejda PDF Desktop crack v{VERSION} by Hodor-Fergus")
        ...
        self.check_process()
        self.patch_files()
        self.print("🎉", "Update to Pro Version successful")
        self.print("⭐", "Would appreciate a star https://github.com/Hodor-Fergus/sejda-crack")
